...
const Trust80G = () => {
  return (
    <div>
      <p>
        It is a license issued to NGOs whose donors can claim deduction while
        calculating their taxable income. If an NGO gets itself registered under
        section 80G then the person or the organization making a donation to the
        NGO will get a deduction from his/its taxable income. A Trust or Society
        or Section 8 Company can apply for license under Section 80G of the
        Income Tax Act.
      </p>
      <p>
        To encourage people to donate, the government also allows for income tax
        deductions under Section 80G for the amount which has been donated. The
        amount which has been donated by a person is allowed to be claimed as a
        deduction under Section 80G, at the time of filing his income tax
        return.
      </p>
      <p>
        This Deduction for Donation can be claimed by any taxpayer (whether
        Individual/Partnership Firm/HUF /Company/ LLP etc) irrespective of
        whether he is earning income from salary or business. The deduction
      ...
      <p>
        An application for provisional registration under Section 80G in Form
        10A will be made to Income Tax Department one month before the
        commencement of activities and the provisional registration is given by
        the IT department online. The registration once granted shall be valid
        for three years from the Assessment Year from which the registration is
        sought.
      </p>
      <p>
        The provisional registration so granted shall be valid for a period of 3
        years and hence needs to be renewed at the end of the above mentioned
        timelines. The registration so renewed shall be valid only for 5 years
        and needs to be renewed at the end of each 5 years.
      </p>
      <p>
        The applicant has to convert this provisional registration earliest of
        at least 6 months before the expiry or within 6 months of commencement
        of its activities. The application for conversion of provisional
        registration to regular registration will be made to Income Tax
      ...
      <ul className="right-unordered">
        ...
        <li className="mb-2">
          ...
          deduction, the donor is also required to furnish a proof of payment. A
          stamped receipt is issued by the recipient trust in this regard,
          details of which should be mentioned by the taxpayer while filing his
          Income Tax Return.
        </li>
      </ul>
      ...
      <ol className="ms-3">
        ...
        <li>Trustees/Members/Directors Address Proofs:</li>
        ...
        <li>Trustees/Members/Directors latest passport size photograph</li>
        <li>Trustees/Members/Directors Email ids</li>
        <li>
          Trustees/Members/Directors Mobile Numbers linked with their Aadhar
        </li>
        <li>
      ...
      <ol className="ms-3">
        ...
        <li>Trust/Society/Company PAN</li>
        <li>FCRA Registration Certificate if any</li>
        <li>DARPAN ID if any</li>
        <li>CSR Certificate if any</li>
        <li>
          Existing order granting approval under clause (23C) of section 10
        </li>
        <li>
          In case of existing entities, copies of annual accounts for the period
          not exceeding 3 years immediately preceding the year in which the
          application is made
        </li>
        <li>
          Where the income of the entity includes profits and gains of business
          as per the provisions of sub-section (4A) of section 11, copies of
          annual accounts and audit report u/s 44AB for 3 years immediately
          preceding the year in which the said application is made
        </li>
        <li>
          Details of activities since its inception or last three years
          whichever is less
        </li>
      </ol>
      <h3 className="mt-3">
      ...
      <ol>
        <li>
          Log on to the E-filing portal of IT department video{" "}
        ...
        <li>
          Select the Form Name as “Form 10A” and relevant Assessment Year from
          the drop down list
        </li>
        <li>
        ...
        <li>
          Fill in the details as required in the form and attach the required
          and applicable attachments
        </li>
        <li>
          Submit the form using digital signatures or EVC as required while
          return filing
        </li>
      </ol>
      ...
      <div className="table-responsive">
        <table className="table table-gray table-bordered">
          ...
          <tbody>
            <tr>
              <td>Gross Total Income</td> <td>XXXX</td>
            </tr>
            <tr>
              <td>Less: Long Term Capital Gains</td> <td>XXX</td>
            </tr>
            <tr>
              <td>Less: Short Term Capital Gains on Sale of Share u/s 111A</td>{" "}
              <td>XXX</td>
            </tr>
            <tr>
              <td>Less: Deductions under Section 80C to Section 80U</td>{" "}
              <td>XXX</td>
            </tr>
            <tr>
              <td>= Adjusted Gross Total Income</td> <td>XXXX</td>
            </tr>
            <tr>
              <td>Less: Deduction under Section 80G*</td> <td>XXX</td>
            </tr>
            <tr>
              <td>= Total Taxable Income</td> <td>XXXX</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p>
        The balance income after deductions of donations would be taxable as per
        the income tax slabs of the taxpayer.
      </p>
      <p>
        Computation of whether deduction is allowed without any maximum limit or
        is limited to 10% of the adjusted gross total income depends on the type
        of institution to whom the amount has been donated. The donations to
        institutions which are eligible for deduction without any limit and
      ...
      <p>
        The following donations are allowed to be claimed as a deduction under
        section 80G. However, in some cases the full deduction is allowed of the
      ...
      <p>
        The following deductions are allowed subject to a maximum of 10% of the
        adjusted gross total income. For eg, if your Adjusted Total Income is
        Rs. 9,00,000 (computed as per method given above), you would be allowed
      ...
      <p>
        ...
        donation is made to any of the following, you can claim deduction for
