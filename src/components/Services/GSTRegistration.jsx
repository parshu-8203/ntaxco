...
const GSTRegistration = () => {
  return (
    <div>
      <h3 className="fw-semibold fs-4">One Nation One Tax - GST</h3>
      <p>
        The implementation of the Goods and Services Tax (GST) in India in 2017
        marked a significant overhaul in the country's tax structure, aligning
        with the concept of "One Nation One Tax." This reform merged central
        taxes (excluding petroleum and alcoholic products, and service tax) with
        state-level taxes (excluding VAT for petroleum and alcoholic products,
        entry tax, transfer tax, and luxury tax), streamlining them into a
        single tax.
      </p>
      <p>
        The primary aim of introducing GST was to eliminate double taxation or
        tax cascading, which occurs from the manufacturing level to the
        consumption level. GST is a value-added tax levied on most goods and
      ...
      <ol>
        <li>
          ...
          (Rs. 20 Lakhs for North-Eastern States, J&K, Himachal Pradesh and
          Uttarakhand)
        </li>
        ...
        <li>
          persons who are required to deduct tax under section 51, whether or
        ...
        <li>
          Input Service Distributor, whether or not separately registered under
          this Act
        </li>
        <li>
      ...
      <p>
        Special Category States are Arunachal Pradesh, Assam, Jammu & Kashmir,
        Manipur, Meghalaya, Mizoram, Nagaland, Puducherry, Sikkim, Tripura,
        Himachal Pradesh and Uttarakhand. Any person may register under
