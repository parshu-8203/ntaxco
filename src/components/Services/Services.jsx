    ...
    return (
        <>
            ...
            <div style={{ marginTop: "100px" }} className="container">
                <h1 style={{ color: "#0049B7" }} className="text-center mb-4">{serviceName}</h1>
                    ...
                    <div className="col-md-4">
                        <div className="card sticky small-card custom-card ">
                            <div className="card-body">
                                <h5 className="card-title">Register to Service</h5>
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-2">
                                        ...
                                        <input type="text" className="form-control" id="service" value={serviceName} readOnly />
                                    </div>
