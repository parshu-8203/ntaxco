...
const OPC = () => {
  return (
    <div>
      <p>
        The concept of One Person Company was introduced in the Companies Act,
        2013 with an intention to provide limited liability to the individual
        entrepreneurs with an innovative technology business idea. One Person
        Private Limited Company will enjoy the same benefits of a normal Private
        Limited Company. An individual who does not have the co-founder to start
        his business venture may incorporate One Person Private Limited Company
        and enjoy the benefits available under Companies Act, 2013. An
        individual who wants test his business idea may start OPC Company and
        once the project is viable, he can approach the Venture Capitalists and
        get the investment into equity share capital and convert into a normal
        Private Limited Company. The regulative body for the Companies is The
      ...
      <p>
        The OPC Company registration in India is entirely online. If you’re
        looking to make your company registered, then CompaniesHouse is the team
        for you. Register your OPC company online with us today and you’ll be on
      ...
      <ul class="right-unordered">
        <li>
          ...
          register only one OPC. Now NRI or Foreign citizen can also register
          One Person Company in India provided he or she has to met the criteria
          of residential status in India (ie. He or She has to be there in India
          for a period of 120 days during the previsous year).
        </li>
        <li>
          Authorised Share Capital is the amount up to which, you can invest in
          the company as share capital.
        </li>
        <li>
          Paidup Share Capital is the amount up to which, you can deposit in the
      ...
      <p>
        Now the One Person Private Limited Company can be registered simply in 3
      ...
      <ol>
        ...
        <p class="p-2">
          ...
          DIR-2, Form INC-9, eAGILE Form, Director & Nominee KYC documents, NOC
          and other declarations as may be required) and once you give
      ...
      <p>
        ...
        is a protection to the personal assets of the Director or Shareholder.
      ...
      <p>
        ...
        a one man show Company, whatever the decisions he or she takes care are
